...
/*   Updated: 2023/02/09 16:43:13 by tvan-der      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    try 
    {
        std::vector<int>::iterator iter = easyfind(intVec, num);
        std::cout << "Found " << *iter << "!\n";
    ...
    // try 
    // {
    //     std::vector<int>::iterator iter = easyfind(intVecEmpty, num);
    //     std::cout << "Found " << *iter << "!\n";
    // } catch (const std::exception& e) {
    //     std::cout << num << " not found in container" << "\n";
    // }
    ...
    // try 
    // {
    //     std::array<int,7>::iterator iter = easyfind(intArr, num);
    //     std::cout << "Found " << *iter << "!\n";
    // } catch (const std::exception& e) {
    //     std::cout << num << " not found in container" << "\n";
    // }
    ...
    // try 
    // {
    //     std::deque<int>::iterator iter = easyfind(intDeque, num);
    //     std::cout << "Found " << *iter << "!\n";
    // } catch (const std::exception& e) {
    //     std::cout << num << " not found in container" << "\n";
    // }
    ...
    // try 
    // {
    //     std::list<int>::iterator iter = easyfind(intList, num);
    //     std::cout << "Found " << *iter << "!\n";
    // } catch (const std::exception& e) {
    //     std::cout << num << " not found in container" << "\n";
    // }
